        ...
        ?>
            ...
            <?php
                ...
                if ($row['answer'] != NULL) {
                    ...
                    echo '<textarea name="answer_data" id="answer_textarea" cols="100" rows="4" required></textarea>';
                    echo '<br>';
                    echo '<input type="submit" value="Answer" class="float_left" id="answer_button">';
                }
            }
        }
